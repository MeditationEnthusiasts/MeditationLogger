...
{
    /// <summary>
    /// This is a CLI, no sound will be used.
    /// Therefore, this is a class that does literally nothing, it just implements the interface.
    /// </summary>
    public class EmptyMusicManager : IMusicManager
    {
        // ---------------- Fields ----------------
        ...
        /// </summary>
        public IReadOnlyList<string> SupportedFormats => this.formats;
