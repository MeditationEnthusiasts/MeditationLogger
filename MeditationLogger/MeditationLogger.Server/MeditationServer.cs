...
namespace MeditationEnthusiasts.MeditationLogger.Server
{
    public class MeditationServer : IDisposable
    {
        // -------- Fields --------
        ...
        public MeditationServer( Api.Api api, short port = DefaultPort, Action<string> consoleOutFunction = null )
        {
